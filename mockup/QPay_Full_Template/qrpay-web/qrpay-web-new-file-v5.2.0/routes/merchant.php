...
use App\Http\Controllers\Merchant\SetupPinController;
...
Route::prefix("merchant")->name("merchant.")->group(function(){
    ...
    Route::middleware('module:merchant-receive-money')->group(function(){
        Route::controller(ReceiveMoneyController::class)->prefix('receive-money')->name('receive.money.')->group(function(){
            Route::get('/','index')->name('index');
            Route::post('refund-balance-make-payment','refundBalanceForMakePayment')->name('refund.balance.make.payment');
            Route::post('refund-balance-payment-gateway','refundBalanceForPaymentGateway')->name('refund.balance.payment.gateway');
        });
    });
     //Pay Link
     Route::middleware(['module:merchant-pay-link','merchant.pin.setup.guard'])->group(function(){
    ...
    //money out
    Route::middleware(['module:merchant-withdraw-money','merchant.pin.setup.guard'])->group(function(){
