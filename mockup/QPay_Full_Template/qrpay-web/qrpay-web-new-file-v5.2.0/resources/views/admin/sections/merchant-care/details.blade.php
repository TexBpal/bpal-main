...
<div class="dashboard-area">
    ...
    <div class="custom-card mt-15">
        <div class="card-header">
            <h6 class="title">{{ __("Merchant Overview") }}</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="user-action-btn-area">
                            <div class="user-action-btn">
                                @include('admin.components.button.custom',[
                                    ...
                                    'permission'    => "admin.merchants.wallet.balance.update",
                                ])
                            </div>
                            <div class="user-action-btn">
    ...
    <div class="custom-card mt-15">
        <div class="card-header">
            <h6 class="title">{{ __("Information of Merchant") }}</h6>
        </div>
        <div class="card-body">
            <form class="card-form" method="POST" action="{{ setRoute('admin.merchants.details.update',$user->username) }}">
                @csrf
                <div class="row mb-10-none">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                        @include('admin.components.form.switcher', [
                            ...
                            'permission'    => "admin.merchants.details.update",
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                        @include('admin.components.form.switcher', [
    ...
    {{-- Send Email Modal --}}
    @include('admin.components.modals.send-mail-merchant',compact("user"))
    {{-- User Balance Update Modal --}}
    @if (admin_permission_by_name("admin.merchants.wallet.balance.update"))
        <div id="wallet-balance-update-modal" class="mfp-hide large">
            <div class="modal-data">
                ...
                <div class="modal-form-data">
                    <form class="modal-form" method="POST" action="{{ setRoute('admin.merchants.wallet.balance.update',$user->username) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-10-none">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".login-as-member").click(function() {
                var action  = "{{ setRoute('admin.merchants.login.as.member',$user->username) }}";
