        ...
        <div class="dashboard-list-item-wrapper">
            <div class="dashboard-list-item sent">
                ...
                <div class="dashboard-list-right">
                    ...
                    @elseif($item->type == payment_gateway_const()::VIRTUALCARD)
                        <h4 class="main-money text--warning">{{ get_amount($item->request_amount,strtoupper($item->details->card_info->currency??get_default_currency_code())) }}</h4>
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            @elseif ($item->type == payment_gateway_const()::MOBILETOPUP)
                                <span class="fw-bold">{{ get_amount($item->payable,get_default_currency_code()) }}</span>
                            @elseif ($item->type == payment_gateway_const()::VIRTUALCARD)
                                <span class="fw-bold"> {{ get_amount(@$item->details->card_info->amount??@$item->details->card_info->balance,strtoupper($item->details->card_info->currency ?? get_default_currency_code())) }}</span>
