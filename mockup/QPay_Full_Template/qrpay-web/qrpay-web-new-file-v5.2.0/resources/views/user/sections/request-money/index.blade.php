...
<script>
     ...
     var senderCurrencyId = "{{ get_default_currency()->id }}";
        ...
        function getFees() {
            ...
            $(".fees-show").html("{{ __('fee And Charge') }} : " + parseFloat(charges.fixed).toFixed(acceptVar().sPrecison) + " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(acceptVar().sPrecison) + "%  ");
        }
        function getPreview() {
