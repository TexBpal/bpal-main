                            ...
                            <div class="row">
                                ...
                                @if($basic_settings->user_pin_verification == true)
                                        <div class="col-xl-12 col-lg-12">
                                            <a href="javascript:void(0)" class="btn--base w-100 btn-loading addMoneyBtn" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Add Money") }} <i class="fas fa-plus-circle ms-1"></i></a>
                                ...
                                @else
                                    <div class="col-xl-12 col-lg-12">
                                        <button type="submit" class="btn--base w-100 btn-loading addMoneyBtn">{{ __("Add Money") }} <i class="fas fa-plus-circle ms-1"></i></button>
                                    </div>
                                </div>
                            @endif
                        </form>
