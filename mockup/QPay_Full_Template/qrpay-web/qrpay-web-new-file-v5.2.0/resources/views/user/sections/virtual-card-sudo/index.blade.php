...
<div class="body-wrapper">
    <div class="dashboard-area mt-10">
        <div class="dashboard-header-wrapper">
            ...
            <a href="{{ setRoute('user.sudo.virtual.card.create.page') }}" class="btn--base small" >{{ __("create Card") }} <i class="las la-plus ms-1"></i></a>
            @endif
        </div>
    </div>
                                ...
                                <div class="dash-payment-item active">
                                    <div class="card-header-btn-wrapper d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0)" class="small--btn">{{ __("balance") }}:
                                            ...
                                            @endphp
                                                {{  getAmount(updateSudoCardBalance(auth()->user(),$myCard->card_id,$live_card_data),2) }} {{ get_default_currency_code() }}
                                            @endif
                                         </a>
                                    </div>
                                    ...
                                    <div class="virtual-card-btn-area text-center pt-20">
                                        ...
                                        @endif
                                        <a href="{{ setRoute('user.sudo.virtual.card.fund.page',$myCard->id) }}" class="btn--base" data-id="{{ $myCard->id }}" data-card-currency="{{ $myCard->currency }}"><i class="fas fa-hand-holding-usd me-1"></i> {{ __("fund") }}</a>
