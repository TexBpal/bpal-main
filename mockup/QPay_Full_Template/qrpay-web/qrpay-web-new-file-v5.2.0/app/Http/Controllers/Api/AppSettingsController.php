...
class AppSettingsController extends Controller
{
    public function appSettings(){
        ...
        $basic_settings_user = [
            ...
            'pin_verification'      =>  $basic_settings->user_pin_verification,
        ];
        $basic_settings_agent = [
            ...
            "timezone"              => @$basic_settings->timezone,
            'pin_verification'      => $basic_settings->agent_pin_verification,
        ];
        $basic_settings_merchant = [
            ...
            "timezone"              => @$basic_settings->timezone,
            'pin_verification'      => $basic_settings->merchant_pin_verification,
        ];
