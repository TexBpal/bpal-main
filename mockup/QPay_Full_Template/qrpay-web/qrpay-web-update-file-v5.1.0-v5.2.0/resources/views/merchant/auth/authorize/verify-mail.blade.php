    ...
    <section class="account">
        <div class="account-area">
            <div class="account-wrapper">
                ...
                <form action="{{ setRoute('merchant.authorize.mail.verify',$token) }}" class="account-form" method="POST">
                    @csrf
                    ...
                    <div class="row ml-b-20">
                        ...
                        <div class="col-lg-12 form-group text-start">
                            <div class="forgot-item">
                                <label><a href="{{ setRoute('merchant.login') }}" class="text--base">{{ __("Back to Login") }}</a></label>
                            </div>
                        </div>
    ...
    function resetTime (second = 60) {
        ...
        var x = setInterval(function () {  // Get today's date and time
            ...
            if (distance < 0 || second < 2 ) {
                ...
                document.querySelector(".time-area").innerHTML = "Didn't get the code? <a href='{{ setRoute('merchant.authorize.resend.code') }}' onclick='resendOtp()' class='text--danger'>Resend</a>";
            }
