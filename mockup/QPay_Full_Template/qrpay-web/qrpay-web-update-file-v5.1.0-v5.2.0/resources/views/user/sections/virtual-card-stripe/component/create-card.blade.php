            ...
            <div class="dash-payment-item-wrapper">
                <div class="dash-payment-item active">
                    ...
                    <div class="dash-payment-body">
                        <form class="card-form" action="{{ route('user.stripe.virtual.card.create') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="input-group">
                                        ...
                                        <select class="form--control nice-select" name="currency">
                                            ...
                                            <option value="{{ $item->currency_code }}"
                                                ...
                                                data-name="{{ $item->country }}" {{ $item->currency_code == get_default_currency_code() ? 'selected' : '' }}>{{ $item->currency_code }}</option>
                                            @endforeach
                                        </select>
                                </div>
                            </div>
