...
<section class="account">
    <div class="account-area">
        <div class="account-wrapper">
            ...
            <p class="d-block text-center">{{ __("We sent a 6 digit code to your email") }} {{ $user_email }}</p>
            <form class="account-form" action="{{ setRoute('agent.password.forgot.verify.code',$token) }}" method="POST">
                @csrf
    ...
    function resetTime (second = 60) {
        ...
        var x = setInterval(function () {  // Get today's date and time
            ...
            if (distance < 0 || second < 2 ) {
                ...
                document.querySelector(".time-area").innerHTML = "Didn't get the code? <a href='{{ setRoute('agent.password.forgot.resend.code',$token) }}' class='text--danger'>Resend</a>";
            }
