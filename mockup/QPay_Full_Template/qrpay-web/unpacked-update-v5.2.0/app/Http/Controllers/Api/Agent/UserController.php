...
class UserController extends Controller
{
    ...
    public function home(){
        ...
        $data =[
            ...
            'pin_verification'          => $this->basic_settings->agent_pin_verification,
    ...
    public function getRemainingBalance(){
        ...
        try{
            $result = (new TransactionLimit())->trxLimit('agent_id',$sender_wallet->agent->id,$validated['transaction_type'],$sender_wallet->currency,$validated['sender_amount'],$limits,$validated['attribute'],'json',$extra_rate);
