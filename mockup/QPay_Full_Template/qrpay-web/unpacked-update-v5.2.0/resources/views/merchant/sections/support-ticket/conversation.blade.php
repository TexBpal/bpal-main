        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ get_image($support_ticket->creator->image,"merchant-profile") }}" alt="client">
                ...
                <div class="chat-container messages">
                    <ul>
                        @foreach ($support_ticket->conversations ?? [] as $item)
                            <li class="media media-chat @if ($item->sender_type == "MERCHANT") media-chat-reverse sent @else replies @endif">
...
@include('admin.components.support-ticket.conversation.connection-merchant',[
    'support_ticket' => $support_ticket,
    'route'          => setRoute('merchant.support.ticket.messaage.send'),
])
