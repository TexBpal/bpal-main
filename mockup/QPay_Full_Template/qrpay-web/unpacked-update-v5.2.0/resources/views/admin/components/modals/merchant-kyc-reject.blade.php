@if (admin_permission_by_name("admin.merchants.kyc.reject"))
    @isset($user)
            ...
            <div id="reject-modal" class="mfp-hide large">
                <div class="modal-data">
                    ...
                    <div class="modal-form-data">
                        <form class="modal-form" method="POST" action="{{ setRoute('admin.merchants.kyc.reject',$user->username) }}" enctype="multipart/form-data">
                            @csrf
