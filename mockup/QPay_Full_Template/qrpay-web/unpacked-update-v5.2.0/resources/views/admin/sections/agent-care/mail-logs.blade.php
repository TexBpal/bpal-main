        ...
        <div class="table-wrapper">
            ...
            <div class="table-responsive">
                <div class="table-area">
                    <div class="table-wrapper">
                        <div class="table-header">
                            <h5 class="title">{{ __("Agent Email Logs") }}</h5>
                        </div>
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @forelse ($logs as $key => $item)
                                        <tr>
                                            <td>
                                                <ul class="user-list">
                                                    <li><img src="{{ $item->agent->agentImage }}" alt="user"></li>
                                                </ul>
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ setRoute('admin.agents.details',$item->agent->username) }}" class="btn btn--base"><i class="las la-info-circle"></i></a>
                                            </td>
                                        </tr>
                                    @empty
