            ...
            <div class="custom-inner-card mt-10 mb-10">
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "PIN Verification"),
                                'name'          => 'user_pin_verification',
                                'value'         => old('user_pin_verification',$basic_settings->user_pin_verification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                ...
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "PIN Verification"),
                                'name'          => 'agent_pin_verification',
                                'value'         => old('agent_pin_verification',$basic_settings->agent_pin_verification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                ...
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "PIN Verification"),
                                'name'          => 'merchant_pin_verification',
                                'value'         => old('merchant_pin_verification',$basic_settings->merchant_pin_verification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
