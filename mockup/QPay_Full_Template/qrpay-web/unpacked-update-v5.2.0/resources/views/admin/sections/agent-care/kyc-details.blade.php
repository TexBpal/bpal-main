...
@section('content')
    ...
    <div class="custom-card mt-15">
        <div class="card-header">
            ...
            @include('admin.components.link.custom',[
                'href'          => setRoute('admin.agents.details',$user->username),
                'text'          => "Profile",
                'class'         => "btn btn--base",
                ...
                <div class="product-sales-btn">
                    @if ($user->kyc_verified != global_const()::VERIFIED)
                        @include('admin.components.button.custom',[
                            ...
                            'text'          => "Approve",
                            'permission'    => "admin.agents.kyc.approve",
                        ])
                    @endif
                    ...
                    @if ($user->kyc_verified != global_const()::REJECTED)
                        @include('admin.components.button.custom',[
                            ...
                            'text'          => "Reject",
                            'permission'    => "admin.agents.kyc.reject",
                        ])
                    @endif
                </div>
            @else
    ...
    @include('admin.components.modals.agent-kyc-reject',compact("user"))
@endsection

@push('script')
    <script>
        $(".approve-btn").click(function(){
            var actionRoute = "{{ setRoute('admin.agents.kyc.approve',$user->username) }}";
