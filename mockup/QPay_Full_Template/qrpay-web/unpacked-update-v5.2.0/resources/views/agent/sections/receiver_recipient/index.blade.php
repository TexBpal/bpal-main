...
<div class="body-wrapper">
    <div class="dashboard-area mt-10">
        <div class="dashboard-header-wrapper">
            ...
            <a href="{{ setRoute('agent.receiver.recipient.add') }}" class="btn--base">{{ __("Add") }} <i class="fas fa-plus-circle ms-2"></i></a>
        </div>
    </div>
                ...
                <div class="dashboard-list-item sent">
                    ...
                    <div class="dashboard-list-right">
                        <div class="dashboard-list-right-btn-area">
                            <a href="{{ setRoute('agent.receiver.recipient.send.remittance',$data->id) }}" class="btn--base"><i class="fas fa-paper-plane"></i></a>
                            <a href="{{ setRoute('agent.receiver.recipient.edit',$data->id) }}" class="btn--base"><i class="fas fa-edit"></i></a>
...
<script>
     $(".delete-btn").click(function(){
            var actionRoute =  "{{ setRoute('agent.receiver.recipient.delete') }}";
