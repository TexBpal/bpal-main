            ...
            <div class="dashboard-header-wrapper d-block d-sm-flex">
                ...
                <div class="dashboard-btn-wrapper mt-3 mt-sm-0">
                    <div class="dashboard-btn">
                        <a href="{{ route('agent.support.ticket.create') }}" class="btn--base"><i class="las la-plus me-1"></i>{{ __("Add New") }}</a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($support_tickets as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('agent.support.ticket.conversation',encrypt($item->id)) }}" class="btn btn--base"><i class="las la-comment"></i></a>
                                </td>
                            </tr>
                        @empty
