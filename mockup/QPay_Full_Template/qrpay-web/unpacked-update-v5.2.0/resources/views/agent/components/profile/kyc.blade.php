@if ($basic_settings->agent_kyc_verification == true && isset($kyc_data) && $kyc_data != null && $kyc_data->fields != null)
    ...
    <div class="card-body">
        ...
        @elseif (auth()->user()->kyc_verified == global_const()::REJECTED)
            <div class="unverified text--danger kyc-text d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ setRoute('agent.authorize.kyc') }}" class="btn--base">{{ __("Verify KYC") }}</a>
            </div>
            <div class="rejected">
