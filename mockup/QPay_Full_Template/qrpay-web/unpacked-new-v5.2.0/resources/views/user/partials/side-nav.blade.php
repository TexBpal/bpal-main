            ...
            <div class="sidebar-menu-wrapper">
                <ul class="sidebar-menu">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                @if(module_access('receive-money',$module)->status)
                                    <a href="{{ setRoute('user.receive.money.index') }}" class="submenu-style {{ makeActive('user.receive.money.index') }}">
                                ...
                                @if(isset($referral_info) &&  $referral_info->status == true)
                                    <a href="{{ setRoute('user.refer.level.index') }}" class="submenu-style {{ makeActive('user.refer.level.index') }}">
                                ...
                                @if(module_access('remittance-money',$module)->status)
                                    <a href="{{ setRoute('user.receipient.index') }}" class="submenu-style {{ makeActive('user.receipient.index') }}">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                ...
                                @if(module_access('add-money',$module)->status)
                                    <a href="{{ setRoute('user.add.money.index') }}" class="submenu-style {{ makeActive('user.add.money.index') }}">
                                ...
                                @if(module_access('withdraw-money',$module)->status)
                                    <a href="{{ setRoute('user.money.out.index') }}" class="submenu-style {{ makeActive('user.money.out.index') }}">
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                ...
                                @if(module_access('send-money',$module)->status)
                                    <a href="{{ setRoute('user.send.money.index') }}" class="submenu-style {{ makeActive('user.send.money.index') }}">
                                ...
                                @if(module_access('make-payment',$module)->status)
                                    <a href="{{ setRoute('user.make.payment.index') }}" class="submenu-style {{ makeActive('user.make.payment.index') }}">
                                ...
                                @if(module_access('money-out',$module)->status)
                                    <a href="{{ setRoute('user.agent.money.out.index') }}" class="submenu-style {{ makeActive('user.agent.money.out.index') }}">
                                        <i class="submenu-icon fas fa-arrow-alt-circle-left text--base"></i>
                                        <span class="menu-title">{{ __("Money Out") }}</span>
                                    </a>
                                @endif
                                @if(module_access('request-money',$module)->status)
                                    <a href="{{ setRoute('user.request.money.index') }}" class="submenu-style {{ makeActive('user.request.money.index') }}">
                                ...
                                @if(module_access('pay-link',$module)->status)
                                    <a href="{{ setRoute('user.payment-link.index') }}" class="submenu-style {{ makeActive('user.payment-link.index') }}">
                     ...
                     <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                @if(module_access('remittance-money',$module)->status)
                                    <a href="{{ setRoute('user.remittance.index') }}" class="submenu-style {{ makeActive('user.remittance.index') }}">
                                ...
                                @if(module_access('bill-pay',$module)->status)
                                    <a href="{{ setRoute('user.bill.pay.index') }}" class="submenu-style {{ makeActive('user.bill.pay.index') }}">
                                ...
                                @if(module_access('mobile-top-up',$module)->status)
                                    <a href="{{ setRoute('user.mobile.topup.index') }}" class="submenu-style {{ makeActive('user.mobile.topup.index') }}">
                            ...
                            <li class="sidebar-menu-item">
                                ...
                                @if(module_access('virtual-card',$module)->status)
                                    @if(virtual_card_system('flutterwave'))
                                        <a href="{{ setRoute('user.virtual.card.index') }}" class="submenu-style {{ makeActive('user.virtual.card.index') }}">
                                    ...
                                    @elseif(virtual_card_system('sudo'))
                                        <a href="{{ setRoute('user.sudo.virtual.card.index') }}" class="submenu-style {{ makeActive('user.sudo.virtual.card.index') }}">
                                            <i class="submenu-icon fas fa-credit-card text--base"></i>
                                            <span class="menu-title">{{ __("Virtual Card") }}</span>
                                        </a>
                                    @elseif(virtual_card_system('stripe'))
                                        <a href="{{ setRoute('user.stripe.virtual.card.index') }}" class="submenu-style {{ makeActive('user.stripe.virtual.card.index') }}">
                                            <i class="submenu-icon fas fa-credit-card text--base"></i>
                                            <span class="menu-title">{{ __("Virtual Card") }}</span>
                                        </a>
                                    @elseif(virtual_card_system('strowallet'))
                                        <a href="{{ setRoute('user.strowallet.virtual.card.index') }}" class="submenu-style {{ makeActive('user.strowallet.virtual.card.index') }}">
                                            <i class="submenu-icon fas fa-credit-card text--base"></i>
                                            <span class="menu-title">{{ __("Virtual Card") }}</span>
                                        </a>
                                    @endif
                                ...
                                @if(module_access('gift-cards',$module)->status)
                                    <a href="{{ setRoute('user.gift.card.index') }}" class="submenu-style {{ makeActive('user.gift.card.index') }}">
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                <a href="{{ setRoute('user.security.google.2fa') }}" class="submenu-style {{ makeActive('user.security.google.2fa') }}">
                                ...
                                @if($basic_settings->user_pin_verification == true)
                                    <a href="{{ setRoute('user.setup.pin.index') }}" class="submenu-style {{ makeActive('user.setup.pin.index') }}">
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                <a href="{{ setRoute('user.transactions.index') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index') }}">
                                    <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                    <span class="menu-title">{{ __("All Transactions") }}</span>
                                </a>
                                @if(module_access('add-money',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','add-money') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'add-money') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Add Money") }}</span>
                                    </a>
                                @endif
                                @if(module_access('withdraw-money',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','withdraw') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'withdraw') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("withdraw") }}</span>
                                    </a>
                                @endif
                                @if(module_access('send-money',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','transfer-money') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'transfer-money') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Send Money") }}</span>
                                    </a>
                                @endif
                                @if(module_access('make-payment',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','make-payment') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'make-payment') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Make Payment") }}</span>
                                    </a>
                                @endif
                                @if(module_access('money-out',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','money-out') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'money-out') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Money Out") }}</span>
                                    </a>
                                @endif
                                @if(module_access('request-money',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','request-money') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'request-money') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("request Money") }}</span>
                                    </a>
                                @endif
                                @if(module_access('pay-link',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','payment-link') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'payment-link') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Payment Link") }}</span>
                                    </a>
                                @endif
                                @if(module_access('remittance-money',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','remittance') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'remittance') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Remittance") }}</span>
                                    </a>
                                @endif
                                @if(module_access('bill-pay',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','bill-pay') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'bill-pay') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Bill Pay") }}</span>
                                    </a>
                                @endif
                                @if(module_access('mobile-top-up',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','mobile-topup') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'mobile-topup') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Mobile Topup") }}</span>
                                    </a>
                                @endif
                                @if(module_access('virtual-card',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','virtual-card') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'virtual-card') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Virtual Card") }}</span>
                                    </a>
                                @endif
                                @if(module_access('gift-cards',$module)->status)
                                    <a href="{{ setRoute('user.transactions.index','gift-card') }}" class="submenu-style {{ makeActiveRouteSlugOnly('user.transactions.index', 'gift-card') }}">
                                        <i class="submenu-icon fas fa-ellipsis-h text--base"></i>
                                        <span class="menu-title">{{ __("Gift Card") }}</span>
                                    </a>
                                @endif
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                <a href="{{ setRoute('user.profile.index') }}" class="submenu-style {{ makeActive('user.profile.index') }}">
