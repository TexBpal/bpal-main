                            ...
                            <div class="row">
                                ...
                                @if($basic_settings->user_pin_verification == true)
                                        <div class="col-xl-12 col-lg-12">
                                            <button type="button" class="btn--base w-100 btn-loading transfer" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Confirm Payment") }} <i class="fas fa-paper-plane ms-1"></i></button>
                                        </div>
                                    </div>
                ...
                <div class="dash-payment-item active">
                    ...
                    <div class="dash-payment-body">
                        <div class="preview-list-wrapper">
                            ...
                            @if ($makePaymentCharge->daily_limit > 0)
                                <div class="preview-list-item">
                                    <div class="preview-list-left">
                                        <div class="preview-list-user-wrapper">
                                            <div class="preview-list-user-icon">
                            ...
                            @endif
                            @if ($makePaymentCharge->monthly_limit > 0)
                                <div class="preview-list-item">
                                    <div class="preview-list-left">
                                        <div class="preview-list-user-wrapper">
                                            <div class="preview-list-user-icon">
...
<script>
    ...
    function acceptVar() {
        ...
        var currencyMinAmount       ="{{getAmount($makePaymentCharge->min_limit)}}"
        var currencyMaxAmount       = "{{getAmount($makePaymentCharge->max_limit)}}"
        var currencyFixedCharge     = "{{getAmount($makePaymentCharge->fixed_charge)}}"
        var currencyPercentCharge   = "{{getAmount($makePaymentCharge->percent_charge)}}"
        var currencyDailyLimit      = "{{getAmount($makePaymentCharge->daily_limit)}}";
        var currencyMonthlyLimit    = "{{getAmount($makePaymentCharge->monthly_limit)}}";
    ...
    function getFees() {
        ...
        $(".fees-show").html("{{ __('Payment Fee') }}: " + parseFloat(charges.fixed).toFixed(acceptVar().sPrecison) + " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(acceptVar().sPrecison) + "%  ");
    }
    function getPreview() {
