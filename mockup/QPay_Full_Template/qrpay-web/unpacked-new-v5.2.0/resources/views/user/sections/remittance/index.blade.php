                            ...
                            <div class="row">
                                ...
                                @if($basic_settings->user_pin_verification == true)
                                        <div class="col-xl-12 col-lg-12">
                                            <button type="button" class="btn--base w-100 btn-loading confirmed" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Continue") }} <i class="fas fa-paper-plane ms-1"></i></button>
                                        </div>
                                    </div>
...
<script>
   ...
   $(document).ready(function(){
    ...
    function checkReciverCountry(){
        ...
        if(from_country == to_country && tranaction_name != 'wallet-to-wallet-transfer'){
    ...
    function getExchangeRate(event) {
            ...
            $('.rate-show').html("1 " + defualCurrency + " = " + parseFloat(currencyRate).toFixed(acceptVar().sPrecison) + " " + currencyCode);
    }
    ...
    function getFees() {
           ...
           $(".fees-show").html("{{ __('charge') }}: " + parseFloat(charges.fixed).toFixed(acceptVar().sPrecison) + " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(acceptVar().sPrecison) + "%  ");
       }
    ...
    function getReceiverAmount() {
            ...
            if($.isNumeric(sender_amount)) {
                ...
                receiver_will_get = parseFloat(receiver_will_get).toFixed(acceptVar().sPrecison);
    ...
    function getPreview() {
            ...
            $('.recipient-amount').text(parseFloat(receiveAmount).toFixed(acceptVar().sPrecison) + " " + receiverCurrency);
