    ...
    <div class="dashboard-area mt-10">
        <div class="dashboard-header-wrapper">
            ...
            @if ($totalCards  < $card_limit )
             <a  href ="{{ setRoute("user.stripe.virtual.card.create.page") }}" class="btn--base small " >{{__("create Card")}} <i class="las la-plus ms-1"></i></a >
            @endif
        </div>
    </div>
                            ...
                            <div class="dash-payment-item-wrapper">
                                <div class="dash-payment-item active">
                                    <div class="card-header-btn-wrapper d-flex align-items-center justify-content-between">
                                        ...
                                        @if($cardApi->config->stripe_mode == global_const()::SANDBOX)
                                            <a href="javascript:void(0)" class="small--btn">{{ __("balance") }}:
                                                {{ __("TEST MODE" )}}
                                             </a>
                                        @elseif ($cardApi->config->stripe_mode == global_const()::LIVE)
                                            <a href="javascript:void(0)" class="small--btn">{{ __("balance") }}:
                                                {{ get_amount(@$myCard->amount,strtoupper($myCard->currency), get_wallet_precision()) }}
                                            </a>
                                        @endif
                                    </div>
                                            ...
                                            <div class="card-custom">
                                                <div class="flip">
                                                    <div class="front bg_img" data-background="{{ get_image(@$cardApi->image ,'card-api') }}">
                                                        ...
                                                        <div class="end">
                                                            <span class="end-text">{{ __("exp. end:") }}</span> <span class="end-date"> {{ $myCard->expiryMonth > 9 ?'':'0' }}{{$myCard->expiryMonth }}/{{$myCard->expiryYear }}</span>
                                                        </div>
