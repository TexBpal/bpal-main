                               ...
                               @if($receiver_token)
                                ...
                                @if($basic_settings->agent_pin_verification == true)
                                        <div class="col-xl-12 col-lg-12">
                                            <button type="type" class="btn--base w-100 btn-loading confirmed" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Continue") }} <i class="fas fa-paper-plane ms-1"></i></button>
                                        </div>
                                    </div>
