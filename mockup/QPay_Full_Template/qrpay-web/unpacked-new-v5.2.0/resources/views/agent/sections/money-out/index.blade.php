                            ...
                            <div class="row">
                                ...
                                @if($basic_settings->agent_pin_verification == true)
                                        <div class="col-xl-12 col-lg-12">
                                            <a href="javascript:void(0)" class="btn--base w-100 btn-loading withdrawBtn" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Withdraw Money") }} <i class="fas fa-arrow-alt-circle-right ms-1"></i></a>
                                        </div>
                                    </div>
