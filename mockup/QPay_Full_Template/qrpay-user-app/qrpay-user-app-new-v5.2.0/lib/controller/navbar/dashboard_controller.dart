  ...
  Stream<DashboardModel> getDashboardDataStream() async* {
    while (isLoggedIn.value) {
      ...
      if (isLoggedIn.value) {
        ...
        Get.find<AppSettingsController>().getSplashAndOnboardData();
        isFirst.value = false;
        yield data;
      }
    }
  ...
  Future<DashboardModel> getDashboardData() async {
    ...
    await ApiServices.dashboardApi().then((value) async {
      _dashboardModel = value!;
       ...
       pinStatus.value = _dashboardModel.data.user.pinStatus;
      pinVerification.value = _dashboardModel.data.pinVerification;
      pinCode.value = _dashboardModel.data.user.pinCode.toString();
