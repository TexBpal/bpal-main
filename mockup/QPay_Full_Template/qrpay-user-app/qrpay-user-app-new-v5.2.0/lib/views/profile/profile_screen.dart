      ...
      children: [
        ...
        !Get.find<DashBoardController>().pinVerification.value
            ...
            : Container(
                ...
                padding: EdgeInsets.all(Dimensions.paddingSize * 0.4),
                decoration: BoxDecoration(
                    color: controller.pinSetUp.value
                        ? CustomColor.primaryLightColor
                        : Get.isDarkMode
                            ? CustomColor.primaryBGDarkColor
                            : CustomColor.primaryLightScaffoldBackgroundColor,
                ...
                child: InkWell(
                  onTap: (() {
                    controller.pinSetUp.value = true;
                    Timer(const Duration(milliseconds: 10), () {
                      controller.pinSetUp.value = false;
                      Get.toNamed(Routes.pinSetupScreen);
                    });
                  }),
                  child: Padding(
                    padding:
                        EdgeInsets.only(left: Dimensions.paddingSize * 1.3),
                    child: TileWidget(
                      iconColor: controller.pinSetUp.value
                          ? CustomColor.whiteColor
                          : CustomColor.primaryLightColor,
                      textColor: controller.pinSetUp.value
                          ? CustomColor.whiteColor
                          : Get.isDarkMode
                              ? CustomColor.primaryDarkTextColor
                              : CustomColor.primaryTextColor,
