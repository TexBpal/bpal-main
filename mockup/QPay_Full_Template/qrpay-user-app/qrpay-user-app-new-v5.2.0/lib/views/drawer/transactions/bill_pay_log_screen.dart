...
class BillPayLogScreen extends StatelessWidget {
  const BillPayLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.billPay;
    return SizedBox(
  ...
  _mainListWidget(int i, List<BillPay> data, BuildContext context) {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ExpendedItemWidget(
                        title: Strings.billType.tr,
                        value: data[i].billType,
                      ),
                      ExpendedItemWidget(
                        title: Strings.billNumber.tr,
                        value: data[i].billNumber,
                      ),
                      ExpendedItemWidget(
