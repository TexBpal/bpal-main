...
class WithdrawLogScreen extends StatelessWidget {
  const WithdrawLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.moneyOut;
    return SizedBox(
  ...
  _mainListWidget(int i, List<MoneyOut> data, BuildContext context) {
