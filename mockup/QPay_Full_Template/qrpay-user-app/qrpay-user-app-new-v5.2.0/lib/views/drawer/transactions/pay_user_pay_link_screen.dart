...
class PayUserPayLinkScreen extends StatelessWidget {
  const PayUserPayLinkScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.payUserPayLink;
    return SizedBox(
  ...
  _mainListWidget(int i, List<PayUserPayLink> data, BuildContext context) {
