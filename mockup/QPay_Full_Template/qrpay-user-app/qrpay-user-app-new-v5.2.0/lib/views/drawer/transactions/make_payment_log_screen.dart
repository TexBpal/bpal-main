...
class MakePaymentLogScreen extends StatelessWidget {
  const MakePaymentLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.makePayment;
    return SizedBox(
  ...
  _mainListWidget(int i, List<MakePayment> data, BuildContext context) {
      ...
      child: Column(
        children: [
          TransactionWidget(
            ...
            amount: data[i].recipientReceived,
