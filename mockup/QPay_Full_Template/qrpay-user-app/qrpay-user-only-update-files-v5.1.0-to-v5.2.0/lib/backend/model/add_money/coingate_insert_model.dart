...
CoinGateInsertModel coinGateInsertModelFromJson(String str) =>
    CoinGateInsertModel.fromJson(json.decode(str));

String coinGateInsertModelToJson(CoinGateInsertModel data) =>
    json.encode(data.toJson());

class CoinGateInsertModel {
  Message message;
  Data data;
  ...
  factory CoinGateInsertModel.fromJson(Map<String, dynamic> json) =>
      CoinGateInsertModel(
