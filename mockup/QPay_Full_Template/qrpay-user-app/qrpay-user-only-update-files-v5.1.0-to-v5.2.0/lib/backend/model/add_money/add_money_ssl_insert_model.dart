...
AddMoneySslInsertModel addMoneySslInsertModelFromJson(String str) => AddMoneySslInsertModel.fromJson(json.decode(str));

String addMoneySslInsertModelToJson(AddMoneySslInsertModel data) => json.encode(data.toJson());
...
class AddMoneySslInsertModel {
    ...
    factory AddMoneySslInsertModel.fromJson(Map<String, dynamic> json) => AddMoneySslInsertModel(
