...
//
//     final flutterWavePaymentModel = flutterWavePaymentModelFromJson(jsonString);

import 'dart:convert';

AddMoneyFlutterWavePaymentModel flutterWavePaymentModelFromJson(String str) => AddMoneyFlutterWavePaymentModel.fromJson(json.decode(str));

String flutterWavePaymentModelToJson(AddMoneyFlutterWavePaymentModel data) => json.encode(data.toJson());

class AddMoneyFlutterWavePaymentModel {
  Message message;
  Data data;

  AddMoneyFlutterWavePaymentModel({
    required this.message,
    required this.data,
  });

  factory AddMoneyFlutterWavePaymentModel.fromJson(Map<String, dynamic> json) => AddMoneyFlutterWavePaymentModel(
