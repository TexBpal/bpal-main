        ...
        children: [
          Row(
            children: [
              ...
              TitleHeading4Widget(
                text:
                    ": ${limitData.minLimit} ${userData!.first.currency.code} - ${limitData.maxLimit} ${userData.first.currency.code}",
                color: CustomColor.primaryLightColor,
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              TitleHeading4Widget(
                text:
                    ": ${userData.first.balance} ${userData.first.currency.code}",
                color: CustomColor.primaryLightColor,
              ),
            ],
          ),
        ...
        Row(
          ...
          children: [
            ...
            Obx(
              () => TitleHeading4Widget(
                text:
                    "${controller.totalCharge.value} ${userData!.first.currency.code}",
        ...
        Row(
          ...
          children: [
            ...
            Obx(
              () => TitleHeading4Widget(
                text:
                    "${controller.totalPay.value} ${userData!.first.currency.code}",
                fontSize: Dimensions.headingTextSize5,
              ),
            ),
          ],
