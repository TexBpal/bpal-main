...
class VirtualCardLogScreen extends StatelessWidget {
  const VirtualCardLogScreen({super.key, required this.controller});
  final TransactionController controller;

  @override
  Widget build(BuildContext context) {
    var data = controller.transactioData.data.transactions.virtualCard;
    return SizedBox(
  ...
  _mainListWidget(int i, List<VirtualCard> data, BuildContext context) {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ExpendedItemWidget(
                        title: Strings.cardAmount.tr,
                        value: data[i].cardAmount,
                      ),
                      ExpendedItemWidget(
                        title: Strings.cardMasked.tr,
