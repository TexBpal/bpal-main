...
class CustomColor {
  static Color primaryDarkColor = const Color(0xFF0C56DB);
  static const Color secondaryDarkColor = Color(0xFF0D102F);
  static const Color primaryBGDarkColor = Color.fromARGB(255, 30, 35, 91);
  ...
  static const Color primaryLightScaffoldBackgroundColor = Color(0xFFF3F3F3);
  ...
  static const Color successColor = Color(0xFF00BB78);
  static const Color pendingColor = Color(0xFFFF9C09);
  static const Color kDarkBlue = Color(0xFFd5deef);
}
