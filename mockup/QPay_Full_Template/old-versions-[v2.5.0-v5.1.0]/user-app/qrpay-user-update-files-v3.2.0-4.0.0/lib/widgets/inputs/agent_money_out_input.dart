...
class AgentMoneyOutInputWithDropdown extends StatefulWidget {
  ...
  const AgentMoneyOutInputWithDropdown({
    Key? key,
  ...
  @override
  State<AgentMoneyOutInputWithDropdown> createState() => _PrimaryInputWidgetState();
}

class _PrimaryInputWidgetState extends State<AgentMoneyOutInputWithDropdown> {
  FocusNode? focusNode;
  final currencyController = Get.put(AgentMoneyOutController());
