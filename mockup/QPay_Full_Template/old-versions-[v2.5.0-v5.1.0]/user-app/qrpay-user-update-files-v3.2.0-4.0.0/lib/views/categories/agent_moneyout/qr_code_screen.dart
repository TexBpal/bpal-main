...
class QRCodeAgentMoneyOutScreen extends StatefulWidget {
  const QRCodeAgentMoneyOutScreen({Key? key}) : super(key: key);

  @override
  ScanScreenState createState() => ScanScreenState();
}

class ScanScreenState extends State<QRCodeAgentMoneyOutScreen> {
    ...
    controller!.scannedDataStream.listen(
      (barcode) => setState(
        () {
          ...
          agentMoneyOutController.getCheckUserWithQrCodeData(
            this.barcode!.code.toString(),
          );
          // Get.back();
          debugPrint(this.barcode!.code);

          agentMoneyOutController.copyInputController.text =
              this.barcode!.code!;
