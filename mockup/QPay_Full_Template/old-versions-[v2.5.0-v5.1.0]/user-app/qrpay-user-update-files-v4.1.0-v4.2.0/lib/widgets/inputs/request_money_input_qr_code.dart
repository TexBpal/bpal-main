...
import 'package:qrpay/controller/categories/request_money/request_money_controller.dart';
...
class CopyRequestMoneyInputWidget extends StatefulWidget {
  ...
  @override
  State<CopyRequestMoneyInputWidget> createState() =>
      _PrimaryInputWidgetState();
}

class _PrimaryInputWidgetState extends State<CopyRequestMoneyInputWidget> {
  FocusNode? focusNode;
