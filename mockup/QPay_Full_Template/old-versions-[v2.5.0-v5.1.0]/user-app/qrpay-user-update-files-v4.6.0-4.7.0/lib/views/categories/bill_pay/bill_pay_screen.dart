        ...
        children: [
          ...
          CustomInputDropDown(
            ...
            onChanged: ((v) {
              ...
              controller.automaticLimitMax.value = v.minLocalTransactionAmount!;
          ...
          InputWithText(
            ...
            onChanged: (v) {
              ...
              //   controller.getAutomaticFee(rate: controller.rate.value);
              // } else {
          ...
          Obx(
            () {
              return controller.isAutomatic.value
                  ? LimitWidget(
                      fee:
                          '${controller.automaticCharge.value.toStringAsFixed(4)} ${controller.baseCurrency.value}',
                      limit:
