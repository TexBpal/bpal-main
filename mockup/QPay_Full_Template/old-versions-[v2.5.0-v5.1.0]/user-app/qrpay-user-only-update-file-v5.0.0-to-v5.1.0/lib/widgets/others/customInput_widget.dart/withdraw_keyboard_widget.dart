            ...
            Row(
              ...
              children: [
                ...
                TitleHeading5Widget(
                    color: CustomColor.primaryLightColor.withValues(alpha: 0.6),
                    text:
                        ": ${controller.remainingController.remainingDailyLimit.value} ${controller.currencyCode.value}"),
              ],
            ),
            Row(
              mainAxisAlignment: mainCenter,
              children: [
                ...
                TitleHeading5Widget(
                    color: CustomColor.primaryLightColor.withValues(alpha: 0.6),
                    text:
                        ": ${controller.remainingController.remainingMonthLyLimit.value} ${controller.currencyCode.value}"),
              ],
            ),
          ],
        ));
